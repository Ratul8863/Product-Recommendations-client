...
const TermsOfUse = () => {
  return (
    <div className="max-w-5xl mx-auto px-6 py-12 text-gray-200">
      ...
      <p className="mb-6">
        Welcome to <strong className="text-lime-300">RecoSys</strong>. These Terms of Use govern your access to and use of our platform, including all content, features, and services made available through <span className="text-lime-300">https://recosys.com</span>. By accessing or using the platform, you agree to be bound by these terms.
      </p>

      {/* Section 1 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">1. Acceptance of Terms</h2>
      <p className="mb-5">
      ...
      {/* Section 2 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">2. Eligibility</h2>
      <p className="mb-5">
      ...
      {/* Section 3 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">3. User Responsibilities</h2>
      <p className="mb-5">
      ...
      {/* Section 4 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">4. Intellectual Property</h2>
      <p className="mb-5">
      ...
      {/* Section 5 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">5. Limitation of Liability</h2>
      <p className="mb-5">
      ...
      {/* Section 6 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">6. Termination</h2>
      <p className="mb-5">
      ...
      {/* Section 7 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">7. Changes to Terms</h2>
      <p className="mb-5">
