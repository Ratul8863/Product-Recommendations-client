...
const Queries = () => {
    ...
    useEffect(() => {
        ...
        fetch('https://product-reco-server-i9d009gff-ratul8863s-projects.vercel.app/queries') // Assuming this endpoint gives all queries
            .then(res => res.json())
            .then(data => {
    ...
    const handleLike = async (id) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                const updated = await fetch('https://product-reco-server-i9d009gff-ratul8863s-projects.vercel.app/queries').then(res => res.json());
