...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-5xl mx-auto px-6 py-12 text-gray-200">
      ...
      <p className="mb-6">
        At <strong className="text-lime-300">RecoSys</strong>, your privacy is important to us. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information when you use our platform. By accessing or using our services, you agree to the terms outlined below.
      </p>

      {/* Section 1 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">1. Information We Collect</h2>
      <p className="mb-5">
      ...
      {/* Section 2 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">2. How We Use Your Information</h2>
      <p className="mb-5">
      ...
      {/* Section 3 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">3. Sharing Your Data</h2>
      <p className="mb-5">
        We do <span className="font-semibold text-lime-300">not sell</span> your personal data. We may share your data with trusted service providers (e.g., Firebase, analytics platforms) for platform functionality, but always under strict confidentiality agreements.
      </p>

      {/* Section 4 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">4. Data Security</h2>
      <p className="mb-5">
      ...
      {/* Section 5 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">5. Your Rights</h2>
      <p className="mb-5">
      ...
      {/* Section 6 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">6. Third-Party Links</h2>
      <p className="mb-5">
      ...
      {/* Section 7 */}
      <h2 className="text-2xl font-semibold text-lime-300 mt-10 mb-3">7. Updates to This Policy</h2>
      <p className="mb-5">
      ...
      <p className="mt-10">
        ...
        <Link to="/contact" className="text-lime-300 underline hover:text-lime-400">contact us</Link>.
      </p>
    </div>
  );
};
